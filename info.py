...
API_ID = int(environ.get('API_ID', '25471015')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '0ab2955ad5b1a913e220800b5fc5db36')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "8307497926:AAG6uCdUGm8zbs33O8uwooqAcYs8kWDhcx4")    # Bot token from @BotFather
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002600085277")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002600085277")# Channels for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Pola:847W4OCWipv7SWLK@cluster0.4i1mbru.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://Database:kSfhLqo1mKhIFNLN@cluster0.v8whu6g.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002474664348')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002474664348')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/tutorialshortlinks/10")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/tutorialshortlinks/10")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/tutorialshortlinks/10")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "c0faab1f5c6e9d47a38356b93ccc278fe27f5672") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "arlinks.in") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "c0faab1f5c6e9d47a38356b93ccc278fe27f5672")  # Shortener API key for second website
...
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "arlinks.in") # Shortener website for third website
